...
let ParcelBundlerService = class ParcelBundlerService {
    ...
    prepareBundler(file, outDir = null) {
        return __awaiter(this, void 0, void 0, function* () {
            return new Promise((resolve, reject) => {
                const options = Object.assign({ target: this.isBrowserBuild ? 'browser' : 'node', minify: this.isBuildMinfied, outDir: outDir || this.buildOutDir }, this.settings);
